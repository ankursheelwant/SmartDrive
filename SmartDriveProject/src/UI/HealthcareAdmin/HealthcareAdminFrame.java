 ...
 * @author Ankur
 */
public class HealthcareAdminFrame extends javax.swing.JFrame {
    ...
    Network network;
    public HealthcareAdminFrame(UserAccount account,EcoSystem system,Network network, Enterprise enterprise, Organization organization) {
        initComponents();
    ...
    private void initComponents() {
        ...
        emergencyRequestPanel = new javax.swing.JPanel();
        jScrollPane3 = new javax.swing.JScrollPane();
        workRequestJTable = new javax.swing.JTable();
        dispatchAmbulanceBtn = new javax.swing.JButton();
        ...
        emergencyRequestPanel.setBackground(new java.awt.Color(255, 255, 255));
        ...
        dispatchAmbulanceBtn.setBackground(new java.awt.Color(255, 255, 255));
        dispatchAmbulanceBtn.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        dispatchAmbulanceBtn.setForeground(new java.awt.Color(0, 102, 153));
        dispatchAmbulanceBtn.setText("Dispatch Ambulance");
        dispatchAmbulanceBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                dispatchAmbulanceBtnActionPerformed(evt);
            }
        });

        warningLabel2.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        warningLabel2.setForeground(new java.awt.Color(255, 0, 0));

        javax.swing.GroupLayout emergencyRequestPanelLayout = new javax.swing.GroupLayout(emergencyRequestPanel);
        emergencyRequestPanel.setLayout(emergencyRequestPanelLayout);
        emergencyRequestPanelLayout.setHorizontalGroup(
            emergencyRequestPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(emergencyRequestPanelLayout.createSequentialGroup()
                .addGroup(emergencyRequestPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(emergencyRequestPanelLayout.createSequentialGroup()
                        .addGap(40, 40, 40)
                        .addComponent(jScrollPane3, javax.swing.GroupLayout.PREFERRED_SIZE, 718, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(emergencyRequestPanelLayout.createSequentialGroup()
                        .addGap(311, 311, 311)
                        .addComponent(dispatchAmbulanceBtn))
                    .addGroup(emergencyRequestPanelLayout.createSequentialGroup()
                        .addGap(175, 175, 175)
                        .addComponent(warningLabel2, javax.swing.GroupLayout.PREFERRED_SIZE, 451, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(35, Short.MAX_VALUE))
        );
        emergencyRequestPanelLayout.setVerticalGroup(
            emergencyRequestPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(emergencyRequestPanelLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jScrollPane3, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(warningLabel2, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(34, 34, 34)
                .addComponent(dispatchAmbulanceBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(203, Short.MAX_VALUE))
        );

        tabbedPane.addTab("Emergency Services", emergencyRequestPanel);
    ...
    private void dispatchAmbulanceBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dispatchAmbulanceBtnActionPerformed
        // TODO add your handling code here:
        int selectedRow = workRequestJTable.getSelectedRow();

        if (selectedRow < 0){
            warningLabel2.setText("Select a row first!!");
            return;
        }

        RequestAmbulance request = (RequestAmbulance)workRequestJTable.getValueAt(selectedRow, 0);
        request.setMessage("Ambulance is en route");
        request.setStatus("Approved by Healthcare Department");
        ...
        warningLabel2.setText("Ambulance is en route, Traffic Admin has been notified!");

    }//GEN-LAST:event_dispatchAmbulanceBtnActionPerformed
    ...
    private javax.swing.JButton dispatchAmbulanceBtn;
    private javax.swing.JPanel emergencyRequestPanel;
